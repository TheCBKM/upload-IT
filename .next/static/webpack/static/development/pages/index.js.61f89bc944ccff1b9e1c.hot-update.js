...
var index = /*#__PURE__*/function (_Component) {
  ...
  function index() {
    ...
    Object(_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_7__["default"])(Object(_babel_runtime_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_3__["default"])(_this), "submit", function _callee(event) {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              console.log('ipfsHash', _this.state); // ipfs.files.add(this.state.file, async (err, res) => {
              //     if (err) {
              //         console.error(err)
              //         return
              //     }
...
//# sourceMappingURL=index.js.61f89bc944ccff1b9e1c.hot-update.js.map