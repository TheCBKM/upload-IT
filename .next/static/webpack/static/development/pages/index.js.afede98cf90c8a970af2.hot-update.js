      ...
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.async(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              console.log(event.target.value); // console.log(accepts.find(a=>a.acc==event.target.value).acc )
              // await this.setState({ fileformat: })
...
//# sourceMappingURL=index.js.afede98cf90c8a970af2.hot-update.js.map