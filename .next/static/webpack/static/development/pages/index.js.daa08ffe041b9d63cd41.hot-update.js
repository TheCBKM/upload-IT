...
var index = /*#__PURE__*/function (_Component) {
  ...
  function index() {
    ...
    Object(_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_7__["default"])(Object(_babel_runtime_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_3__["default"])(_this), "changeFormat", function (event) {
      event.preventDefault();
      console.log(event.target.value);
      console.log(accepts.find(function (a) {
        return a.name == event.target.value;
      }).acc);
      var format = accepts.find(function (a) {
        return a.name == event.target.value;
      }).acc;
...
//# sourceMappingURL=index.js.daa08ffe041b9d63cd41.hot-update.js.map